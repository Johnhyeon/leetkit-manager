...
const TOUR_STEPS = [
  ...
  },
  {
    ...
    desc:
      "연결할 증권사를 고릅니다\n한국투자증권과 키움증권을 지원합니다\n\n" +
      "하나만 연결하면 충분합니다\n여러 곳을 연결하는 것은 선택 사항이고\n" +
      "분석 데이터는 주 사용 증권사 한 곳에서만 가져옵니다",
  },
  {
    selector: "#broker-help-btn",
    demo: "broker",
    title: "증권사별 차이 보기",
    desc:
      "오른쪽 위 물음표를 누르면\n증권사마다 무엇이 다른지 펼쳐집니다\n\n" +
      "한국투자증권은 어디서나 쓸 수 있고\n" +
      "키움증권은 키를 발급할 때 등록한 곳에서만 됩니다\n\n" +
      "노트북으로 장소를 옮겨 다니신다면\n한국투자증권을 권해드립니다\n\n" +
      "다시 누르면 접힙니다",
  },
  {
  ...
  },
  {
    ...
    desc:
      "분봉을 어디서 가져올지 고릅니다\n[증권사 분봉 사용]을 권해드립니다\n\n" +
      "일봉과 주봉, 월봉, 현재가는 지금까지 쓰던 데이터를 그대로 씁니다\n" +
      "수정주가 검증을 마친 뒤에 증권사 데이터로 넓힐 예정입니다\n\n" +
      "무언가 이상할 때는 [증권사 시세 사용 안 함]을 고르세요\n" +
